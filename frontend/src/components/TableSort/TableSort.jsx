...
//             </Text>
//             <Text>
//               <b>Dirección:</b> {selectedClient.address}, {selectedClient.city}, {selectedClient.province}
//             </Text>
//           </>
//         ) : (
...
export function TableSort() {
  ...
  const rows = paginatedData.map((row) => (
    <Table.Tr key={row.id}>
      ...
      <Table.Td>{row.phone}</Table.Td>
      <Table.Td>
        <Button variant="light" size="xs" color="grey" onClick={() => { setSelectedClient(row); open(); }}>
          Ver más
        </Button>
      </Table.Td>
    </Table.Tr>
...
>
 ...
 {/* Botón Agregar Cliente */}
      <Button variant="filled" color="green" onClick={openAddModal} style={{ marginBottom: '1rem' }}>
        Agregar Cliente
      </Button>
